...
const Secureupload = () => {
  ...
  const uploadFile = async (type, timestamp, signature) => {
    ...
    data.append("timestamp", timestamp); // timestamp of uploaded content
    data.append("signature", signature); // signature of uploaded content
    data.append("api_key", process.env.api_key); //since we are using authenticated this time
